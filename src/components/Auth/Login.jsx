...
export const Login = ({ onToggleMode }) => {
    ...
    const { signInWithEmail, signUpWithEmail, signInWithProvider, loading } =
        useAuth();
            ...
            <Card className="w-full max-w-md">
                <CardHeader className="text-center">
                    ...
                    <p className="text-sm text-gray-600 mt-2">
                        {isSignUp
                            ? "Join Contract Critic to analyze your contracts"
                            : "Welcome back to Contract Critic"}
                    </p>
                </CardHeader>
                    ...
                    <div className="space-y-2">
                        ...
                        >
                            <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24">
                                <path
                                    fill="currentColor"
                                    d="M11.4 24H0L8.7 0h12.6L24 9.8H11.4V24z"
                                />
                            </svg>
