...
const ContractUpload = ({ onContractUploaded }) => {
        ...
        <div className="p-6 max-w-4xl mx-auto">
            <div className="mb-6">
                ...
                <p className="text-gray-600">
                    Upload your contract for AI-powered analysis and risk
                    assessment.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Our AI will analyze your contract and provide
                            detailed insights.
                        </CardDescription>
                    </CardHeader>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">
                                        We extract and analyze the text content
                                        from your contract.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Our AI identifies key terms, risks, and
                                        potential issues.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Get a comprehensive risk score and
            ...
            {uploadedFile && (
                <AnalysisTypeDialog
                    contractId={uploadedFile.contract_id}
